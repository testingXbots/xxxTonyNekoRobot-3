...
☛ Blacklists are used to stop certain users from messaging.
 ‣ `/ignore`*:* Add a user to blacklist.
 ‣ `/notice`*:* Remove a user from blacklist.
 ‣ `/ignoredlist`*:* Display's all blacklisted users.
